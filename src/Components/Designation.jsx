...
const Designation = () => {
  return (
    <div>
      <section className="flex flex-col md:flex-row items-center justify-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 gap-44">
        {/* Info Section */}
        <motion.div 
        ...
        >
          ...
          <a
            ...
            download
            className="bg-blue-600 text-white px-4 py-2 my-6 inline-block rounded-lg shadow-md hover:bg-blue-700 transition-transform transform hover:scale-105"
          >
            Resume
          </a>
          ...
          <div className="flex justify-center md:justify-start space-x-4 mt-4">
            ...
            <a href="https://www.linkedin.com/in/fazle-azim/" target="_blank" rel="noopener noreferrer" className="text-gray-800 hover:text-blue-600 text-2xl">
              <FaLinkedin />
            </a>
          </div>
        </motion.div>
